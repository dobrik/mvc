                ...
                <div class="btn-group btn-group-list btn-group-notification">
                    ...
                    <div class="dropdown-menu pull-right">
                        ...
                        <ul class="media-list dropdown-list">
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb" src="/assets/images/photos/user1.png" alt="">
                            ...
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb" src="/assets/images/photos/user2.png" alt="">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb" src="/assets/images/photos/user3.png" alt="">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb" src="/assets/images/photos/user4.png" alt="">
                                <div class="media-body">
    ...
    <div class="mainwrapper">
        <div class="leftpanel">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <li class="parent"><a href=""><i class="fa fa-edit"></i> <span>Products</span></a>
                    <ul class="children">
