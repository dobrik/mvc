<head>
    ...
    <title>Bootstrap Home - Mimity</title>
        ...
        <div class="col-md-5 col-lg-5">
            <form action="/search/" method="get">
                <div class="input-group top_inputs">
                    <input type="text" id="search" autocomplete="off" name="search" placeholder="Enter something to search"
                           class="form-control top_inputs_font">
